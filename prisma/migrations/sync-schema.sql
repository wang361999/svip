...
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "prefAllDrawings" TEXT DEFAULT 'false';
-- 清理已废弃的用户偏好列
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefAutoFib";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefAB9";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefAB9Labels";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefFibonacci";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefFibLabels";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefAutoLines";
ALTER TABLE "User" DROP COLUMN IF EXISTS "prefTrendLines";
