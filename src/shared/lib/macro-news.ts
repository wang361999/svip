...
export const CPI_2026: CpiReport[] = [
  ...
  { releaseDate: '2026-08-13', label: '2026年7月', yoy: 3.3, mom: 0.1, coreYoy: 2.5, forecastYoy: 3.3, previousYoy: 3.5, status: 'released' },
  { releaseDate: '2026-09-11', label: '2026年8月', yoy: 3.4, mom: 0.4, coreYoy: 2.4, forecastYoy: 3.3, previousYoy: 3.3, status: 'released' },
...
export const PCE_2026: PceReport[] = [
  ...
  { releaseDate: '2026-08-29', label: '2026年7月', coreYoy: 3.3, coreMom: 0.2, forecastCoreYoy: 3.3, previousCoreYoy: 3.3, status: 'released' },
